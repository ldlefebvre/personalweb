...
export const experience: Role[] = [
  {
    ...
    current: true,
    summary:
      "Designing and building Sensium: Blind-Tasting Coach — a premium, offline-first wine-study app for sommelier-track students and serious enthusiasts.",
    highlights: [
  ...
  },
  {
    ...
    current: true,
    summary:
      "Leading end-to-end iOS feature development on OpenLane's production app in the automotive wholesale-marketplace space.",
    highlights: [
      "Lead end-to-end development of key iOS features in SwiftUI, shaping architecture and aligning design, backend, Android, and web teams for a consistent cross-platform experience.",
      "Own major parts of the TradeRev decommissioning — redesigning core workflows, integrating new APIs, and modernizing legacy UIKit and storyboard code into scalable SwiftUI components.",
      "Ship well-tested features through rigorous GitHub peer review, QA cycles, and CI/CD with mandated coverage, raising reliability with XCTest (including snapshots), feature flags, and Segment analytics.",
    ],
